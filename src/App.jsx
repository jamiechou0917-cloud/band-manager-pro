...
// v4.7 核心修正：練團費與雜支計算機增加「運算前過濾 (Pre-calc Filter)」，徹底解決鬼魂 ID 導致金額錯誤與未知顯示的問題
import { 
  getAuth, 
  signInWithPopup, 
  GoogleAuthProvider, 
...
import { 
  ...
  BookOpen, FileJson, UploadCloud, Library, Share, ArrowUp, ArrowDown, Wrench, RefreshCw
} from 'lucide-react';
      ...
      <div className="min-h-screen bg-[#FDFBF7] text-[#725E77] font-sans pb-24">
        <header className="bg-white/80 backdrop-blur sticky top-0 z-40 border-b border-[#CBABCA]/20 px-4 py-3 flex justify-between items-center shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[9px] bg-[#E8F1E9] text-[#5F7A61] px-1.5 py-0.5 rounded-full font-bold ml-1">v4.7</span>
          </div>
